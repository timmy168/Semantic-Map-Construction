...
def reconstruct(args):
    ...
    # rgb_images = os.listdir(os.path.join(data_folder_path, "result_model_1/"))
    ...
    # for i in range(1,10):
        if i == 1:
            # target point cloud
            # rgb_principal = data_folder_path + "/result_model_1/%d.png" % i
            ...
            # rgb= data_folder_path + "/result_model_1/%d.png" % i
...
if __name__ == '__main__':
    ...
    o3d.io.write_point_cloud('second_floor_gt.pcd',result_pcd)
    # o3d.io.write_point_cloud('first_floor_model_2.pcd',result_pcd)
    # custom_voxel_down(result_pcd, 0.0025)
